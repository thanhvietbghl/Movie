...
struct AppFont {
    ...
    static func getFont(fontNameType: FontNameType, fontSize: CGFloat) -> UIFont {
        return UIFont(name: fontNameType.rawValue, size: fontSize) ?? UIFont.systemFont(ofSize: fontSize)
    }
}
